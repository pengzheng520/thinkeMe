...
SVG.prototype.plot=function(id,type,fun,x_min,x_max,points,min_type,max_type,stroke1,strokewidth1,strokedash1,visible,pg,t) {
...
SVG.prototype.path=function(plist,id,c,funSrc,pg) {
  ...
  */
  ...
  node.setAttribute("fill", "none");
  node.setAttribute("stroke-dasharray",para[9].split("!"));
  if (para[10]=="F")
  {
...
function reDrawAllFx(pg){
	...
	*/
    ...
    for (var i=0;i<allFx.length;i++)
	{
		...
		plot(para[0],para[1],parseFloat(para[2]),parseFloat(para[3]),para[4],allFx[i][0],para[5],para[6],para[7],para[8],para[9],para[10],pg); 
	}
